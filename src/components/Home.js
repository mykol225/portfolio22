...
export const Home = () => {
  return (
    <main id="home-main">
    <Hero>Hi, I’m <Link to="/contact">Mike→</Link>, a Designer from <Link to="/about">Long Beach→</Link>.  I work as a Product Design Manager for <a href='google.com'>Ibotta→</a> in Denver.  I studied B.S. Graphic Design at the <a href="google.com">Art Institute of California→</a>. </Hero>
